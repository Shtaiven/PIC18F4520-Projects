...
L1
		  ...
		  movff  ADRESH,TWOBITS 	   ;For use by modified ByteDisplay to show lowest 2 bits of ADRESH
          DISPF  ADRESL                ;Display PORTD as a binary number
        ;ENDLOOP_
        bra	L1
PL1
...
;Code to display lowest two bits from ADRESH on top row of LCD
		;REPEAT_
L11
		 clrf  WREG
		 rrcf  TWOBITS,F
...
BYTE_1  db  "\x80ADRES=\x00"         ;Write "BYTE=" to first line of LCD
